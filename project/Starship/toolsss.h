...
class ToolsSS
{
 public:
  ...
  torch::Tensor generateActions(int n, int nTimesteps, int distribution, float std);
  void generateDataSet(string path, int nmaps, int n, int nTimesteps, float trainSetProp, float winProp=0.1, int aDist=0, float std=1);
