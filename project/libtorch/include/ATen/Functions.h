...
static inline bool _use_cudnn_ctc_loss(const Tensor & log_probs, const Tensor & targets, IntArrayRef input_lengths, IntArrayRef target_lengths, int64_t blank) {
    ...
    switch(tensorTypeIdToBackend(impl::dispatchTypeId(at::detail::multi_dispatch_tensor_type_set(log_probs, targets)))) {
        ...
        default:
            AT_ERROR("_use_cudnn_ctc_loss not implemented for ", at::toString(at::detail::multi_dispatch_tensor_type_set(log_probs, targets)));
    }
#else
    static c10::OperatorHandle op = c10::Dispatcher::singleton()
    ...
    return c10::Dispatcher::singleton().callUnboxedOnly<bool, const Tensor &, const Tensor &, IntArrayRef, IntArrayRef, int64_t>(
        op, impl::dispatchTypeId(at::detail::multi_dispatch_tensor_type_set(log_probs, targets)), log_probs, targets, input_lengths, target_lengths, blank);
#endif
}
static inline std::tuple<Tensor,Tensor> _cudnn_ctc_loss(const Tensor & log_probs, const Tensor & targets, IntArrayRef input_lengths, IntArrayRef target_lengths, int64_t blank, bool deterministic, bool zero_infinity) {
#ifdef USE_STATIC_DISPATCH
...
static inline Tensor & angle_out(Tensor & out, const Tensor & self) {
    ...
    switch(tensorTypeIdToBackend(impl::dispatchTypeId(at::detail::multi_dispatch_tensor_type_set(out, self)))) {
        case Backend::CPU:
            ...
            break;
        default:
            AT_ERROR("angle_out not implemented for ", at::toString(at::detail::multi_dispatch_tensor_type_set(out, self)));
    }
#else
    static auto table = globalATenDispatch().getOpTable("aten::angle.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)");
    return table->callUnboxed<Tensor &, Tensor &, const Tensor &>(out, self);
#endif
}
static inline Tensor real(const Tensor & self) {
...
static inline Tensor & real_out(Tensor & out, const Tensor & self) {
    ...
    switch(tensorTypeIdToBackend(impl::dispatchTypeId(at::detail::multi_dispatch_tensor_type_set(out, self)))) {
        case Backend::CPU:
            ...
            break;
        default:
            AT_ERROR("real_out not implemented for ", at::toString(at::detail::multi_dispatch_tensor_type_set(out, self)));
    }
#else
    static auto table = globalATenDispatch().getOpTable("aten::real.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)");
    return table->callUnboxed<Tensor &, Tensor &, const Tensor &>(out, self);
#endif
}
static inline Tensor imag(const Tensor & self) {
...
static inline Tensor & imag_out(Tensor & out, const Tensor & self) {
    ...
    switch(tensorTypeIdToBackend(impl::dispatchTypeId(at::detail::multi_dispatch_tensor_type_set(out, self)))) {
        case Backend::CPU:
            ...
            break;
        default:
            AT_ERROR("imag_out not implemented for ", at::toString(at::detail::multi_dispatch_tensor_type_set(out, self)));
    }
#else
    static auto table = globalATenDispatch().getOpTable("aten::imag.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)");
    return table->callUnboxed<Tensor &, Tensor &, const Tensor &>(out, self);
#endif
}
static inline Tensor conj(const Tensor & self) {
...
static inline Tensor & conj_out(Tensor & out, const Tensor & self) {
    ...
    switch(tensorTypeIdToBackend(impl::dispatchTypeId(at::detail::multi_dispatch_tensor_type_set(out, self)))) {
        case Backend::CPU:
            ...
            break;
        default:
            AT_ERROR("conj_out not implemented for ", at::toString(at::detail::multi_dispatch_tensor_type_set(out, self)));
    }
#else
    static auto table = globalATenDispatch().getOpTable("aten::conj.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)");
    return table->callUnboxed<Tensor &, Tensor &, const Tensor &>(out, self);
#endif
}
static inline Tensor acos(const Tensor & self) {
...
static inline Tensor clone(const Tensor & self, c10::optional<MemoryFormat> memory_format) {
    ...
    return table->callUnboxed<Tensor, const Tensor &, c10::optional<MemoryFormat>>(self, memory_format);
#endif
}
static inline Tensor & resize_as_(Tensor & self, const Tensor & the_template) {
#ifdef USE_STATIC_DISPATCH
